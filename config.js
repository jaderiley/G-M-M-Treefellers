...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "G M M treefellers",
    phone:     "+27 68 001 2245",
    whatsapp:  "+27 68 001 2245",
    address:   "58 Countesses Ave, Randburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "G M M treefellers — Tree felling in randburg",
    description: "G M M treefellers provides professional tree felling in Randburg. 1 Google review. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "G M M treefellers handles tree felling, stump removal and trimming across Randburg and the surrounding suburbs. Professional equipment, safe teams, clean site.",
    ...
    band: {
      ...
      alt:   "G M M treefellers team at work in Randburg",
